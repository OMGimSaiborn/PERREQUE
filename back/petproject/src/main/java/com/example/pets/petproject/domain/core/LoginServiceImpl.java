...
public class LoginServiceImpl implements LoginService {
    ...
    public LoginResponseDTO login(final LoginRequestDTO dto) {
        ...
        if (user == null) {
            return new LoginResponseDTO(false, USER_NOT_FOUND, null, null, null, null, null);
        }
        ...
        if (!matches) {
            return new LoginResponseDTO(false, PASSWORD_NOT_FOUND, null, null, null, null, null);
        }
